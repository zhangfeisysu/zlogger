...
final class LoggerPrinter implements Printer {
     ...
     *
     * @param tag is the given string which will be used in ZLogger
     */
    @Override
    ...
    private void logChunk(int logType, String tag, String chunk) {
        ...
        switch (logType) {
            ...
            case INFO:
                ...
                break;
            case VERBOSE:
                if (settings.getLogLevel() == LogLevel.FULL || settings.getLogLevel() == LogLevel.VERBOSE) {
    ...
    private int getStackOffset(StackTraceElement[] trace) {
        for (int i = MIN_STACK_OFFSET; i < trace.length; i++) {
            ...
            if (!name.equals(LoggerPrinter.class.getName()) && !name.equals(ZLogger.class.getName())) {
                return --i;
            }
        }
        return -1;
